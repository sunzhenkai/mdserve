...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ref={ref}
    className={cn(
      "top-full z-[1] flex h-1.5 items-end justify-center overflow-hidden data-[state=visible]:animate-[fade-in_0.2s_ease-out] data-[state=hidden]:animate-[fade-out_0.15s_ease-in]",
      className
    )}
    {...props}
  >
